    ...
    public function create() {
        if ($this->isPost()) {
            ...
            if ($obj->add($data)) {
                ...
                $this->tuSuccess('添加成功', U('bookingdianping/index'));
            }
            $this->tuError('操作失败');
        } else {
            $this->display();
        ...
        if ($order_id = (int) $order_id) {
            ...
            if ($this->isPost()) {
                ...
                if (false !== $obj->save($data)) {
                    ...
                    $this->tuSuccess('操作成功', U('bookingdianping/index'));
                }
                $this->tuError('操作失败');
            } else {
    ...
    private function editCheck() {
	 ...
	 public function delete($order_id = 0) {
        if (is_numeric($order_id) && ($order_id = (int) $order_id)) {
            ...
            $this->tuSuccess('删除成功2', U('bookingdianping/index'));
        } else {
            ...
            if (is_array($order_id)) {
                ...
                $this->tuSuccess('删除成功', U('bookingdianping/index'));
            }
