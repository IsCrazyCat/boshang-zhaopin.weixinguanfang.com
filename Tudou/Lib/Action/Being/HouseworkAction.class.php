...
class  HouseworkAction extends CommonAction{
    ...
    public function setting2($id){
        ...
        if ($this->isPost()) {			
            ...
            $this->tuSuccess('操作成功', U('housework/setting'));
        }else{
	...
	public function create() {
        if ($this->isPost()) {
            ...
            if ($obj->add($data)) {
                $this->tuSuccess('添加成功', U('housework/setting'));
            }
            $this->tuError('操作失败');
        } else {
            $this->assign('cates', D('Housekeepingcate')->fetchAll());
    ...
    public function edit($housework_id){
        if ($housework_id = (int) $housework_id) {
            ...
            if ($this->isPost()) {
                ...
                if (false !== $obj->save($data)) {
                    $this->tuSuccess('操作成功', U('housework/index'));
                }
                $this->tuError('操作失败');
            } else {
     ...
     public function delete($housework_id = 0) {
        if (is_numeric($housework_id) && ($housework_id = (int) $housework_id)) {
            ...
            $this->tuSuccess('删除成功', U('housework/index'));
        } else {
	...
	public function delete2($id = 0) {
        if (is_numeric($id) && ($id = (int) $id)) {
            ...
            $this->tuSuccess('删除成功', U('housework/setting'));
        } else {
            ...
            if (is_array($id)) {
                ...
                $this->tuSuccess('批量删除成功', U('housework/setting'));
            }
