...
class EleorderAction extends CommonAction{
    ...
    public function export(){
        ...
        $html = "﻿";
        $filter = array('aa' => '订单编号', 'bb' => '年', 'cc' => '月', 'dd' => '日', 'ee' => '下单时间', 'ff' => '订单类型', 'gg' => '企业名称', 'hh' => '会员昵称', 'ii' => '菜品列表', 'jj' => '菜品总数量', 'kk' => '工作价格（元）', 'll' => '配送费用（元）', 'mm' => '实际支付（元）', 'nn' => '是否打印', 'oo' => '是否点评', 'pp' => '支付时间', 'ss' => '收货地址', 'tt' => '省', 'uu' => '市', 'vv' => '县', 'ww' => '姓名', 'xx' => '电话', 'yy' => '订单留言');
