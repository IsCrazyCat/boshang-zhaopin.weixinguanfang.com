...
class GoodscateAction extends CommonAction{
    ...
    public function create($parent_id = 0){
        if ($this->isPost()) {
            ...
            if ($obj->add($data)) {
                $obj->cleanCache();
                $this->tuSuccess('添加成功', U('goodscate/index'));
            }
            $this->tuError('操作失败');
        }else{
        ...
        if ($cate_id = (int) $cate_id) {
            ...
            if ($this->isPost()) {
                ...
                if (false !== $obj->save($data)) {
                    $obj->cleanCache();
                    $this->tuSuccess('操作成功', U('goodscate/index'));
                }
                $this->tuError('操作失败');
            } else {
    ...
    public function delattr($attr_id){
        ...
        $this->tuSuccess('删除成功', U('goodscate/setting', array('cate_id' => $detail['cate_id'])));
    }
    ...
    public function setting($cate_id){
        ...
        if ($this->isPost()) {
            ...
            $this->tuSuccess('操作成功', U('goodscate/setting', array('cate_id' => $cate_id)));
        } else {
            $this->assign('detail', $detail);
            $this->assign('attrs', D('Goodscateattr')->order(array('orderby' => 'asc'))->where(array('cate_id' => $cate_id))->select());
            $this->display();
    ...
    public function update(){
        ...
        $obj->cleanCache();
        $this->tuSuccess('更新成功', U('goodscate/index'));
    }
}