...
class MarketAction extends CommonAction{
   ...
   public function loadcart(){
    ...
    public function pay2() {
        ...
        D('Marketorder')->save(array('addr_id' => $addr_id, 'order_id' => $order_id));
        ...
        if($code == 'wait'){
            ...
            if(empty($logs)){
                $logs = array('type' =>'market','user_id' =>$this->uid,'order_id' =>$order_id,'code' =>$code,'need_pay'=>$order['need_pay'],'create_time'=>NOW_TIME,'create_ip'=>get_client_ip(),'is_paid'=>0);
